    ...
    theme: {
      extend: {
        ...
        fontFamily: {
          ...
          "headline-xl": ["Geist Pixel", "Geist Mono", "ui-monospace", "monospace"],
          "headline-xl-mobile": ["Geist Pixel", "Geist Mono", "ui-monospace", "monospace"],
          "headline-lg": ["Geist Pixel", "Geist Mono", "ui-monospace", "monospace"],
          "headline-lg-mobile": ["Geist Pixel", "Geist Mono", "ui-monospace", "monospace"],
          "headline-md": ["Geist", "ui-sans-serif", "system-ui", "sans-serif"],
          "headline-sm": ["Geist", "ui-sans-serif", "system-ui", "sans-serif"],
          "body-lg": ["Geist", "ui-sans-serif", "system-ui", "sans-serif"],
          "body-md": ["Geist", "ui-sans-serif", "system-ui", "sans-serif"],
          "body-sm": ["Geist", "ui-sans-serif", "system-ui", "sans-serif"],
          "label-md": ["Geist Mono", "ui-monospace", "SFMono-Regular", "Menlo", "monospace"],
          "label-sm": ["Geist Mono", "ui-monospace", "SFMono-Regular", "Menlo", "monospace"],
          "code-md": ["Geist Mono", "ui-monospace", "SFMono-Regular", "Menlo", "monospace"],
          "code-lg": ["Geist Mono", "ui-monospace", "SFMono-Regular", "Menlo", "monospace"],
        },
        fontSize: {
          "headline-md": [
            "22px",
