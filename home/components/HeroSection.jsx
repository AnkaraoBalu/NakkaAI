...
export default function HeroSection() {
  return (
    <section className="relative w-full max-w-7xl mx-auto px-4 sm:px-margin-desktop pt-8 sm:pt-12 pb-6 sm:pb-8 flex flex-col items-center text-center overflow-hidden">
      ...
      <div className="inline-flex items-center gap-space-sm px-space-md py-1 rounded bg-surface-container-low text-on-surface shadow-sm mb-space-lg">
        <span className="w-1.5 h-1.5 rounded-full bg-primary-container shadow-[0_0_8px_#38bdf8] animate-pulse"></span>
        <span className="font-label-sm text-label-sm tracking-wider uppercase text-primary">
          AI Coding Agent for VS Code
        </span>
      </div>

      <h1 className="font-headline-xl text-headline-xl-mobile sm:text-headline-xl lg:text-[48px] lg:leading-[56px] text-on-surface max-w-4xl tracking-tight mb-space-lg">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-center gap-space-md mb-space-lg w-full sm:w-auto">
        <a
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-space-md gap-y-space-xs font-code-md text-code-md text-outline">
